...
- Internet Gateway & Route Table: インターネットからその区画へつながるゲートウェイを作り、迷わずアクセスできるようにルートテーブルを敷く
...
- User Data: サーバーが立ち上がった瞬間に自動的にWebサーバーソフト (Apache)をインストールし、自動起動設定を行い「Hello from Terraform Web Server!」という最初のWebページを設置するスクリプトが動く
